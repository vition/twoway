          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody >
        					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$posts): $mod = ($i % 2 );++$i;?><tr id="del">
                      <td><?php echo ($posts["id"]); ?></td>
                      <td><img src="/Public/<?php echo ($posts["min_url"]); ?>" alt=""></td>
                      <td><button class="btn btn-primary de" value=<?php echo ($posts["id"]); ?>>删除</button></td>
