...
<header id="home">
    		...
    		<div class="row">
    					...
    					<section id="cd-timeline" class="cd-container">
							...
							<div class="cd-timeline-block">
								...
								<div class="cd-timeline-content">
									...
									<p>开始研讨并构建EVENT领域的“客户核心需求”，组建EVENT各专项领域专业团队,启动EVENT业务</p>
								</div>
							</div>
							<div class="cd-timeline-block">
								<div class="cd-timeline-img cd-location">
							...
							<div class="cd-timeline-block">
								...
								<div class="cd-timeline-content">
									...
									<p>为摆脱EVENT领域日趋激烈的“恶性竞争”开始研讨EVENT领域的“核心竞争力”</p>
								</div>
							</div>
							<div class="cd-timeline-block">
								<div class="cd-timeline-img cd-location">
								...
								<div class="cd-timeline-content">
									...
									<p>成立Marketing&Contents部,围绕客户在营销上的需求，构建TWOWAY新的核心业务板块：Sports、体验营销、下沉整合营销、娱乐营销4块核心业务</p>
								</div>
							</div>
							<div class="cd-timeline-block">
								...
								<div class="cd-timeline-content">
									...
									<p>成立第一事业&第二事业本部,对EVENT业务板块进行重新整合,组建并强化“TWOWAY新核心产品”的建设团队;整合营业部门，强化既有客户的营业与经营能力;组建专职的“市场&新客户开发”团队</p>
								</div>
							</div>
    					</section>
    			</div>
    			...
    			<div class="col-xs-12 col-md-7">
    				<div class="about-right">
    					<div>
    						<h1>Twoway Concept之道</h1>
    					</div>
  						<div>
  							<h3><i class="fa fa-linode"></i>The first</h3>
  							<p>最早发现客户与市场核心需求＆最早满足客户与市场核心需求<br/></p>
  						</div>
  						<div>
  						...
  						<div>
  							...
  							<p>围绕客户与市场的核心需求&核心价值与产品，整合并构建核心资源，成为满足客户与市场需求的不可替代的唯一<br/></p>
  						</div>
				...
				<div class="row">
					<div class="col-xs-12 col-md-6 col-md-offset-3">
						<div class="service-heading">
							<h3>我们的服务</h3> 
							<p>Twoway 十年专注服务各汽车品牌，为客户提供一站式360度全方位服务，只为把汽车BTL这块领域做彻底，做得更好，更完美。</p>
						</div>
					</div>
				</div>   	
	    	</div>
    ...
    <section class="services-style-one">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
						<div class="portfolio-heading">
							...
							<p>风雨共济，互相信赖不随流，敢于创新与突破，激发无限的潜能与创造，敢于分享乐于分享，从而达到1+1＞2,打造自己的核心能力</p>
						</div>
					</div>
		...
		<script type="text/javascript">
            var map0 = '';
            var markerArr = [
                { title: "名称：上海分公司", point: "121.43641,31.218926", address: "上海市长宁区延安西路1023号 大众金融大厦 B座2103",contact:"陈志锋", tel: "15626064495" },
                { title: "名称：广州总公司", point: "113.281223,23.137819", address: "广州市越秀区德政北路538号达信大厦8楼", tel: "" },
            ...
            function map_init() {
                ...
                for (var i = 0; i < markerArr.length; i++) {
                    ...
                    // marker[i].setLabel(label);
                      if(i==0){
                          info[i] = new window.BMap.InfoWindow("<p style=’font-size:12px;lineheight:1.8em;’>" + markerArr[i].title + "</br>地址：" + markerArr[i].address+ "</br>联系人：" + markerArr[i].contact+ "</br>联系电话：" + markerArr[i].tel );
                      }else{
                          info[i] = new window.BMap.InfoWindow("<p style=’font-size:12px;lineheight:1.8em;’>" + markerArr[i].title + "</br>地址：" + markerArr[i].address );
                      }
                    }
				...
				<div class="row">
					<div class="col-md-3">
						<div class="footer-heading">
							<h3><span>关于</span>TWOWAY</h3>
							<p> 睿基（TWOWAY）始于２００２年，总部设在“广告创意鼻祖”的城市——广州，作为以“汽车巡展、赛事营销”为主打特色的创新汽车营销创意型公司，经过12年的发展， 已在北京、上海、武汉、成都、重庆、昆明等国内主要大城市设立区域特色分公司。旗下各分公司传承优势，针对各区域开展特色业务，更贴近当地消费和人文特点。睿基已得到越来越多客户的认可，被客户誉为“汽车策划小天才”。</p>
						</div>
					</div>
